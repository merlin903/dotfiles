...
mas install 1384080005  # Tweetbot (2.5.1)
...
mas install 1014850245  # Monit (1.2.2)
mas install 1376402589  # StopTheMadness (4.5)
mas install 1262957439  # Textual 7 (7.1.0)
mas install 868968810   # Fusion360 (1.45.2)
